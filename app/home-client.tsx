...
export default function HomeClient({ students }: Props) {
      ...
      <div className="container" style={{ padding: '20px 16px 40px' }}>
          ...
          {students.length === 0 ? (
            ...
            <div style={{ background: 'white', border: '1px solid #e8dfd6', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 10px rgba(26,71,42,0.04)' }}>
              {sorted.map((student) => {
                ...
                return (
                  <div key={student.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 16px', borderBottom: '1px solid #f5efe8', transition: 'background 0.2s', cursor: 'pointer' }}
                  ...
                  >
                    <button
                      onClick={(e) => { e.stopPropagation(); togglePin(student.id); }}
                      style={{
                        width: '36px',
                        height: '36px',
                        borderRadius: '50%',
        ...
        <section style={{ marginTop: '32px', background: 'white', border: '1px solid #e8dfd6', borderRadius: '16px', padding: '28px 20px', textAlign: 'center', boxShadow: '0 2px 10px rgba(26,71,42,0.04)' }}>
          ...
          <div style={{ marginTop: '14px', display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: '100px', height: '100px', borderRadius: '50%', background: '#c9a94e', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '36px', fontWeight: 700 }}>
        ...
        <footer style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #e8dfd6', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <Link href="/report" className="footer-link-btn">
              Download Report
            </Link>
