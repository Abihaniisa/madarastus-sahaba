  ...
  return (
    <main>
      ...
      <div className="container" style={{ padding: '20px 16px 40px' }}>
        {showInstall && mounted && (
          <div style={{ background: 'white', border: '1px solid #e8dfd6', borderRadius: '16px', padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', margin: '16px 0', boxShadow: '0 2px 10px rgba(26,71,42,0.06)' }}>
            <span style={{ fontSize: '14px', fontWeight: 600, color: '#1e293b' }}>
              Install {SCHOOL.shortName} for a better experience
            </span>
            <button onClick={handleInstall} className="btn-primary" style={{ padding: '10px 20px', fontSize: '13px', flexShrink: 0 }}>
              Install App
            </button>
          </div>
        )}
        ...
        <section style={{ marginTop: '16px' }}>
          <p style={{ color: '#6b5a4a', fontSize: 'clamp(0.875rem, 2.5vw, 0.95rem)', lineHeight: 1.7, textAlign: 'center', maxWidth: '640px', margin: '0 auto' }}>
            {SCHOOL.description}
          </p>
        </section>

        <section style={{ marginTop: '28px' }}>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#1a472a', marginBottom: '12px', textAlign: 'center' }}>
            Students
          </h2>
              ...
              {sorted.map((student, index) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      display: 'grid',
                      gridTemplateColumns: '36px 44px minmax(0, 1fr) 18px',
                      columnGap: '12px',
                      rowGap: '8px',
                      alignItems: 'center',
                      padding: '16px',
                      borderBottom: index === sorted.length - 1 ? 'none' : '1px solid #f5efe8',
                      cursor: 'pointer',
                      minWidth: 0,
                    }}
                  >
                    ...
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill={isPinned ? '#1a472a' : 'none'} stroke={isPinned ? '#1a472a' : '#a6947e'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <path d="M5 17h14l-1.5-4.5V7a2 2 0 0 1 2-2h-7a2 2 0 0 0-2 2v5.5L5 17Z" />
                      </svg>
                    </button>
                    ...
                    >
                      ...
                      <p style={{ fontSize: '11px', color: '#a6947e', marginTop: '3px', lineHeight: 1.3 }}>
                        Reg. No: {student.id}
                      </p>
                    </div>
                    ...
                    <div
                      ...
                      aria-hidden="true"
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a6947e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    >
                      <span style={{ fontWeight: 700, color: '#1a472a', fontSize: '14px', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
                        On-Time {student.stats?.attendance ?? '—'}%
                      </span>
                      <span style={{ fontWeight: 700, color: '#c9a94e', fontSize: '14px', lineHeight: 1.3, whiteSpace: 'nowrap' }}>
