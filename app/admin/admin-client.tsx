...
export default function AdminClient({
  ...
  const [tab, setTab] = useState<'students' | 'attendance' | 'achievements'>(
    'students'
  );
    ...
    try {
      const results = await Promise.all(
        entries.map(async ([studentId, status]) => {
          ...
          if (!res.ok) {
            throw new Error(`Failed to save ${studentId}`);
          }
          return true;
        })
      );
    ...
    <main style={{ minHeight: '100vh', background: '#fafaf8' }}>
      ...
      <div className="container" style={{ padding: '24px 16px' }}>
        ...
        >
          <button
            ...
            style={{
              ...
              fontSize: '14px',
              fontWeight: 500,
              background: tab === 'students' ? '#1a472a' : 'white',
              color: tab === 'students' ? 'white' : '#475569',
              border: '1px solid #e2e8f0',
            }}
          >
            Students
          ...
          <button
            ...
            style={{
              ...
              fontSize: '14px',
              fontWeight: 500,
              background: tab === 'attendance' ? '#1a472a' : 'white',
              color: tab === 'attendance' ? 'white' : '#475569',
              border: '1px solid #e2e8f0',
            }}
          >
            Attendance
          ...
          <button
            ...
            style={{
              ...
              fontSize: '14px',
              fontWeight: 500,
              background: tab === 'achievements' ? '#1a472a' : 'white',
              color: tab === 'achievements' ? 'white' : '#475569',
              border: '1px solid #e2e8f0',
            }}
          >
            Achievements
          ...
          >
            ...
            >
              ...
              <input
                ...
                min="1"
                max="53"
                placeholder="Joining Week (optional)"
                style={{
                  padding: '10px 12px',
                  borderRadius: '8px',
                  border: '1px solid #cbd5e1',
        ...
        {tab === 'attendance' && (
          ...
          >
            <h2 style={{ fontWeight: 600, marginBottom: '12px' }}>
              Record Attendance
            </h2>
            <input
              type="date"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {students
                .filter((s) => s.is_active && s.joining_date !== null)
                .map((student) => {
        ...
        {tab === 'achievements' && (
          ...
          >
            ...
            >
              ...
              <input
                name="category"
                placeholder="Category (e.g., Nahwu, Tajwid)"
                style={{
                  padding: '10px 12px',
                  borderRadius: '8px',
                  border: '1px solid #cbd5e1',
              ...
              {achievements.map((a) => (
                ...
                >
                  <div>
                    ...
                    <p style={{ fontSize: '12px', color: '#64748b' }}>
                      {a.student_id} {a.date ? `— ${a.date}` : ''}
                    </p>
                  </div>
                  <form action="/api/delete-achievement" method="POST">
